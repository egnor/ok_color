...
// All components are 0-255; hue 0=red, 85=green, 170=blue.
struct ok_hsv_888 { uint8_t h, s, v; };

// 360-degree "decimal" HSV. Hue is 0-359, saturation and value are 0-100.
struct ok_hsv_977 { uint32_t h: 9, s: 7, v: 7; };

// 32-bit HSV. Hue is 0-65535, saturation and value are 0-255.
struct ok_hsv_H88 { uint16_t h; uint8_t s, v; };

// 48-bit HSV. All components are 0-65535; hue 0=red, 21845=green, 43690=blue.
...
OK_CONV_CHAIN(ok_lrgb_888, ok_srgb_888, ok_hsv_H88);
...
OK_CONV_CHAIN(ok_lrgb_HHH, ok_srgb_888, ok_hsv_H88);
