...
//
// sRGB component values have a nonlinear "srgb", eg. r/g/b = 127 (50%)
...
// sRGB <-> linear RGB component conversion helpers
extern uint8_t const ok_lin8_srgb8_table[256]; // 8-bit linear to sRGB channel
extern uint8_t const ok_srgb8_lin8_table[256]; // 8-bit sRGB channel to linear
extern uint16_t const ok_srgb8_lin16_table[256]; // 8-bit sRGB to 16-bit linear

inline uint8_t ok_lin8_srgb8(uint8_t v) { return ok_lin8_srgb8_table[v]; }
inline uint8_t ok_srgb8_lin8(uint8_t v) { return ok_srgb8_lin8_table[v]; }
inline uint16_t ok_srgb8_lin16(uint8_t v) { return ok_srgb8_lin16_table[v]; }

extern uint8_t ok_lin16_srgb8(uint16_t v); // 16-bit linear to 8-bit sRGB
extern uint16_t ok_lin16_srgb16(uint16_t v); // 16-bit linear to 16-bit sRGB
extern uint16_t ok_srgb16_lin16(uint16_t v); // 16-bit sRGB to 16-bit linear
...
OK_CONV_RGB(ok_srgb_888, ok_lrgb_888, ok_srgb8_lin8, ok_lin8_srgb8);
OK_CONV_RGB(ok_srgb_888, ok_lrgb_HHH, ok_srgb8_lin16, ok_lin16_srgb8);
OK_CONV_RGB(ok_srgb_HHH, ok_lrgb_HHH, ok_srgb16_lin16, ok_lin16_srgb16);
