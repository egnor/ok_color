...
uint8_t const ok_gamma8_lin8_table[] = {
...
uint16_t const ok_gamma8_lin16_table[] = {
...
uint16_t ok_gamma16_lin16(uint16_t s) {
  // Linear interpolation based on s8_l16
  uint8_t const s_hi = s / 0x100, s_lo = s & 0x100;
  auto const s_a = ok_gamma8_lin16_table[s_hi];
  auto const s_b = ok_gamma8_lin16_table[s_hi + 1];
